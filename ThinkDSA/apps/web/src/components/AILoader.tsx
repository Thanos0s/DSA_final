...
export const AILoader = () => (
    <div style={{ display: 'flex', justifyContent: 'center', width: '100%', transform: 'scale(0.5)', transformOrigin: 'left center' }}>
            ...
            <g transform="translate(-201.44063,-235.75466)">
              <g strokeMiterlimit="10">
                ...
                <path
                  d=""
                  fillOpacity="0.26667"
                  fill="#97affd" /* Keeping original color to preserve robot aesthetic */
                ...
                <path
                  ...
                  fill="none"
                  stroke="#191e2e" /* Adjusted for theme */
                  strokeWidth="7"
                ></path>
              </g>
            </g>
              ...
              <g transform="translate(-164.41679,-112.94712)">
                <g strokeMiterlimit="10">
                  <path
                    ...
                    fill="var(--accent-burnt-orange)" // Changed body color to match theme primary
                    stroke="#191e2e"
                    strokeWidth="5"
                    strokeLinecap="butt"
                  ></path>
                  <path
                    ...
                    fill="var(--accent-earth-green)" // Gradient feel
                    stroke="none"
                    strokeWidth="0"
                    strokeLinecap="butt"
                  ></path>
              ...
              <g transform="translate(-191.87889,-75.62023)">
                <g strokeMiterlimit="10">
                  ...
                  <path
                    ...
                    fill="none"
                    stroke="var(--accent-red)" /* Robot eye laser */
                    strokeWidth="3.5"
                    strokeLinecap="round"
                  ></path>
                  <path
